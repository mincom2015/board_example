...
urlpatterns = [
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/?$', auth_views.PasswordResetConfirmView.as_view(template_name='accounts/password_reset_confirm.html'),
